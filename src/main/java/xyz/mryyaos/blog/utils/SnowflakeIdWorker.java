...
public final class SnowflakeIdWorker {
  ...
  /** 开始时间截 (2018-11-25) */
  private static final long TWEPOCH = 1543131770229L;
  ...
  private SnowflakeIdWorker(long workerId, long dataCenterId) {
    ...
    if (dataCenterId > MAX_DATA_CENTER_ID || dataCenterId < 0) {
      throw new IllegalArgumentException(
          String.format(
              "dataCenterId can't be greater than %d or less than 0", MAX_DATA_CENTER_ID));
    }
  ...
  private static class Nested {
    ...
    private static SnowflakeIdWorker instance = new SnowflakeIdWorker(1, 1);
  }
}
